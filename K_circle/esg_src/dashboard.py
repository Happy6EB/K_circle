...
results_path = os.path.join(base_path, "S_results.csv")   # ✅ S_results.csv 로 변경
...
# 데이터 미리보기 (항상 보이도록)
st.subheader("결과 데이터 미리보기 (S_results.csv)")
st.dataframe(df_results.head())

# ------------------------------------------------
# 1. S_results.csv 기반 기업별 ESG 점수
# ------------------------------------------------
st.subheader("기업별 ESG 점수 현황 (S_results.csv 기반)")
